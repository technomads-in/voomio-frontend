...
const NftDetails = ({ closeModal }) => {
   ...
   return (
      <>
         ...
         <div id="popup-modal" tabindex="-1" className="overflow-y-auto overflow-x-hidden fixed top-10 right-0 left-0 z-50 md:inset-0 h-modal md:h-full py-8 items-center justify-center flex transition duration-700 ease-in-out" aria-modal="true" role="dialog">
            <div className="relative w-full max-w-xl h-full md:h-auto bg-white rounded-xl shadow-2xl ">
               <div className="relative rounded-lg shadow px-4">
                  <button type="button" className="absolute top-1 right-3 text-[#6549F6] bg-transparent rounded-lg text-sm ml-auto inline-flex items-center " data-modal-toggle="popup-modal" onClick={() => { closeModal(false) }}>
