...
const NftGenerator = () => {
  ...
  const handleBtnBasic = () => {
    ...
    btnSelectPrice.className = "text-[white] bg-gradient-to-r from-[#9B53E0] to-[#8551E6] border-2  m-4 font-medium text-xl tracking-wide  md:px-32 py-2 px-16 rounded-full"
    ...
    // btnSelect.className = "cursor-pointer text-[#7B61FF] bg-[#ffffff] border-2 border-[#7B61FF] m-5 font-medium text-xl tracking-wide  md:px-16 py-2 px-8 rounded-full text-center"
    let btnSelectsingleNft = document.getElementById("btnSelectsingleNft");
    btnSelectsingleNft.className = " cursor-pointer text-[white] bg-gradient-to-r from-[#9B53E0] to-[#8551E6] border-2  m-4 font-medium text-xl tracking-wide  md:px-32 py-2 px-16 rounded-full"
  }
  const handleBtnNft = (i) => {
    let btnSelectsingleNft = document.getElementById("btnSelectsingleNft");
    btnSelectsingleNft.className = " cursor-pointer text-[white] bg-gradient-to-r from-[#9B53E0] to-[#8551E6] border-2  m-4 font-medium text-xl tracking-wide  md:px-32 py-2 px-16 rounded-full"
    let btnSelectNftSet = document.getElementById("btnSelectNftSet");
    btnSelectNftSet.className = " cursor-pointer text-[white] bg-gradient-to-r from-[#9B53E0] to-[#8551E6] border-2  m-4 font-medium text-xl tracking-wide  md:px-32 py-2 px-16 rounded-full"
    let NftType = document.getElementById("NftType");
    NftType.className = "pt-10 opacity-100"
    let SingleNft = document.getElementById("SingleNft");
    SingleNft.className = "cursor-pointer  mb-2 mr-5 md:mr-2  rounded-xl border-2 shadow-md  border-[#7B61FF] opacity-100  "
    // let btnSelect = document.getElementById("btn");
    // btnSelect.className = "cursor-pointer text-[white] bg-gradient-to-r from-[#9B53E0] to-[#8551E6] border-2  m-4 font-medium text-xl tracking-wide  md:px-32 py-2 px-16 rounded-full"
  ...
  return (
    <>
      <div className="container max-w-7xl mx-auto px-8 md:px-20 pt-20 ">
        ...
        <div className="text-[#000000]  font-semibold text-2xl pb-8 popuptittle">
        ...
        <div className="">
          ...
          <div>
            <div className="pt-10 opacity-20" id="NftType">
            ...
            <div className="pt-10 grid md:grid-cols-2  grid-col-1 gap-4 " >
              <div className=" mb-2 mr-5 md:mr-2  rounded-xl border-2 shadow-md  border-[#7B61FF] opacity-20 cursor-not-allowed" id="SingleNft">
                <img
              ...
              <div className=" mb-2 mr-5 md:mr-2 rounded-xl border-2 shadow-md  border-[#7B61FF] opacity-20 cursor-not-allowed" id="netSet">
                <img
