...
const Aggregator = () => {
  ...
  const [openaccrodion, setOpenaccrodion] = useState(true);
  const [openaccrodion1, setOpenaccrodion1] = useState(false);
  ...
  const Usersonline = [
    {
      ...
      bluetick: "/images/BadgeCheck.svg",
    },
    {
      id: 1,
      username: "@user123789",
  ...
  const chat = [
    {
      ...
      day: "2 day ago",
      details:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eget justo nec nisi blandit feugiat. Vestibulum vel ex nec neque varius pharetra.",
  ...
  return (
    <>
      ...
      <div className="w-auto h-auto border-b-2 pt-1 mx-auto container" />
      {/* 5th element */}
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <stop offset="1" stopColor="#00DAD9" />
                    </linearGradient>
                  </defs>
                </svg>
              </div>
      ...
      {details === "Community" && (
        <div className="grid lg:grid-cols-2 container mx-auto my-10 lg:pl-32 pl-10">
          <div className="">
            <div
              className="lga:w-3/4 w-4/5 border-2  border-[#6549F6] rounded-lg p-3 flex justify-between items-center font-bold cursor-pointer"
              onClick={() => {
                setOpenaccrodion(!openaccrodion);
                setOpenaccrodion1(false);
              }}
            >
              Collection Chat
              {openaccrodion ? (
                <i className="fa-solid fa-minus  text-[#6549F6]" />
              ) : (
                <i className="fa-solid fa-plus text-[#6549F6]" />
              )}
            </div>
            ...
            {openaccrodion ? (
              <div>
                <div className="mt-10 flex Club">
                  ...
                  <div className="flex flex-col">
                    <div className="flex pl-3">
                      <div className="text-[#6549F6]">@user123789</div>
                      <div className="flex pl-2 text-[#B4BBC6]">
                        Today @ 4:10
                      </div>
                    </div>
                    <div className="pl-3">
                ...
                <div className="flex items-center pl-6 Club">
                  ...
                  <div className="pl-3 text-[#B4BBC6] lg:text-base text-sm">
                ...
                <div className="my-5 flex items-start Club">
                  ...
                  <div className="flex flex-col">
                    ...
                    <img
                      src="/images/dancing-dog 1.svg"
                      alt=""
                      className="pt-5 w-56 h-56"
                    />
                  </div>
                </div>
            ...
            <div
              className="lga:w-3/4 w-4/5 border-2  border-[#6549F6] rounded-lg p-3  mt-10 flex justify-between items-center font-bold cursor-pointer"
              onClick={() => {
                setOpenaccrodion1(!openaccrodion1);
                setOpenaccrodion(false);
              }}
            >
              Collection Threads
              {openaccrodion1 ? (
            ...
            {openaccrodion1 ? (
              <>
                {chat.map((item) => (
                  <div className="flex mt-10 gap-7" key={item.id}>
          ...
          <div className="mt-5">
            <div className="text-base font-bold">Users online</div>
            <div className="mt-10">
      ...
      {opencommentsection && (
        <>
          <div className="fixed z-50 inset-0  bg-[#dac9f9] bg-opacity-[0.7] ">
            <div className="flex justify-center w-max border-0 overflow-hidden rounded-3xl m-auto shadow-lg ">
              <div className="flex flex-col justify-center">
                <div className="bg-[#F4EEFF]  p-5 ">
                  <div
                    className="flex justify-end cursor-pointer"
                    onClick={() => setopencommentsection(false)}
                  >
                    <i className="fa-solid fa-x text-[#6549F6] p-2"></i>
                  </div>
                  ...
                  <div className="flex mt-3 gap-7">
                    ...
                    <div className="flex flex-col ">
                      <div className="flex gap-7">
                        <div className="text-[#6549F6]">@13246</div>
                        <h1 className="text-[#B4BBC6]">2 day ago</h1>
                      </div>
                      <h1 className="font-bold flex items-center justify-center flex-col max-w-xs">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Aperiam velit nulla doloremque similique architecto,
                        obcaecati temporibus debitis dolor consectetur ex
                        voluptatum praesentium quam tempore vel et, quod, ad
                        natus tenetur.
                      </h1>
                    </div>
                  </div>
